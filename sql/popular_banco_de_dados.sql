...
insert into data_agendamento(id_cliente,id_especialidade,id_medico,id_horario,valor_consulta) values
(null,"especialidade 1",null,str_to_date("2015-05-01 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 1",null,str_to_date("2015-05-02 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 2",null,str_to_date("2015-05-03 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 2",null,str_to_date("2015-05-04 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 3",null,str_to_date("2015-05-04 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 3",null,str_to_date("2015-05-05 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 4",null,str_to_date("2015-05-05 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 4",null,str_to_date("2015-05-05 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 1",null,str_to_date("2015-05-06 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 1",null,str_to_date("2015-05-06 00:00:00","%Y-%m-%d %H:%i:%S"),50),
(null,"especialidade 2",null,str_to_date("2015-05-07 00:00:00","%Y-%m-%d %H:%i:%S"),50);
